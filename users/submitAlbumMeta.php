<?php
    ...
    if(isset($_POST['albumID']) && isset($_POST['Atitle']) && isset($_POST['Adescription']) && isset($_POST['flickr_albumID']) &&($user->isLoggedIn())) {
        ...
        $query2 = "select lu.authToken,sa.albumID from ScrapeAlbum sa join LinkUser lu on sa.scrapeUserID=lu.scrapeUserID where sa.id=$albumID and lu.usersID=$useriid";
        ...
        echo '<script type="text/javascript">alert("error, not enough parameter or not logged in");</script>';
    }
